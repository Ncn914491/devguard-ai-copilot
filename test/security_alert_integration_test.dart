  ...
  group('Security Alert Integration Tests', () {
    ...
    test('should filter alerts by severity', () async {
      ...
      final criticalAlerts =
          await securityAlertService.getAlertsBySeverity('critical');
    ...
    test('should filter alerts by status', () async {
      ...
      final resolvedAlerts =
          await securityAlertService.getAlertsByStatus('resolved');
    ...
    test('should assign alerts to team members', () async {
      ...
      // Verify assignment
      final updatedAlert =
          await securityAlertService.getSecurityAlert(alertToAssign.id);
    ...
    test('should provide real-time alert updates', () async {
      ...
      expect(
          newestAlert.detectedAt.isAfter(initialAlerts.isNotEmpty
              ? initialAlerts.first.detectedAt
              : DateTime(2000)),
          isTrue);
    });
    ...
    test('should track alert resolution workflow', () async {
      ...
      // Verify resolution
      final resolvedAlert =
          await securityAlertService.getSecurityAlert(alert.id);
    ...
    test('should generate AI explanations for alerts', () async {
      ...
      for (final alert in alerts) {
        ...
        expect(alert.aiExplanation.length,
            greaterThan(50)); // Substantial explanation
